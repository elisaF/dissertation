...
\renewcommand{\thesisauthorpreviousdegrees}{, B.S. Computer Engineering, M.A. Linguistics}
...
\renewcommand{\thesiscommitteememberb}{Johan Kamp}
...
\renewcommand{\thesisauthoraddress}{elisa@ferraane.com}
                                     %% Your permanent address; use "\\" for
                                     %% linebreaks.

\renewcommand{\thesisdedication}{tbd}
...
\renewcommand{\thesisdedication}{\parbox[c]{0.75\textwidth}{``pithy quote''\begin{flushright}-- Author, \textit{source}\end{flushright}}}
\thesisdedicationpage                %% Generate the dedication page.

\phantomsection
\addcontentsline {toc}{chapter}{}
% TODO uncomment for thesis
